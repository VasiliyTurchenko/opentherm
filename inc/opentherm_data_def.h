...
#ifndef OPENTHERM_DATA_DEF_H
#define OPENTHERM_DATA_DEF_H
...
typedef enum {
	OPENTHERM_ResOK,
	OPENTHERM_ResBadMsgId,    /* bad msg ID */
	OPENTHERM_ResNoAnswer,    /* no answer from slave */
	OPENTHERM_ResBadArg,      /* bad arguments */
	OPENTHERM_ResParityErr,   /* parity error */
	OPENTHERM_ResBadMsgType,  /* bad message type */
	OPENTHERM_ResDataInvalid, /* If the data ID is recognised by the slave but the data requested is not available or invalid.*/
