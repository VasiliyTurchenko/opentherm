...
/*0*/	{.msgId = MSG_ID_STATUS,           rd, fl8, fl8,   0u, BitField, BitField, .Lowest.iVal = INT_MIN,   .Highest.iVal = INT_MAX},       /* u16 */
...
/*40*/	{.msgId = MSG_ID_REMOTE_OVERRIDE,  rd, fl8, none,  8u, BitField, Unnamed,  .Lowest.iVal = INT_MIN,   .Highest.iVal = INT_MAX},
